...
gnome-terminal --window --title "hycan_visualization" -e 'bash -c "roslaunch --wait hycan_visualization hycan_vis.launch ; exec bash;"'
gnome-terminal --window --title "hycan_track" -e 'bash -c "roslaunch --wait hycan_comm hycan_tracker.launch ; exec bash;"'