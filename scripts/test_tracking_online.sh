...
--tab --title "visual_det" -e 'bash -c "source ~/miniforge-pypy3/etc/profile.d/conda.sh; conda activate platoon; echo $(which python); rosrun image_tracking vehicle_detection.py; exec bash;"' \
