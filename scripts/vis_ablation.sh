...
--tab --title "vis" -e 'bash -c "roslaunch --wait exp_pose_visualization exp_pose_visualization.launch; exec bash;"' \
--tab --title "rviz" -e 'bash -c "rviz -d ../src/utils/exp_pose_visualization/rviz/ablation.rviz; exec bash;"' \