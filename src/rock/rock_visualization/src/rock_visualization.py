...
class ImageSubscriber:
    def __init__(self):
        ...
        left_sub = Subscriber('/driver/fisheye/left/compressed', CompressedImage)
        front_sub = Subscriber('/driver/fisheye/front/compressed', CompressedImage)
        right_sub = Subscriber('/driver/fisheye/right/compressed', CompressedImage)
        back_sub = Subscriber('/driver/fisheye/back/compressed', CompressedImage)
        ...
        for direction in ["front", "back", "right", "left"]:
            ...
            self.cam_models[direction] = CamModel(direction, "Rock")
    ...
    def detection_callback(self, msg):
        ...
        for direction in ["front", "right", "back", "left"]:
            ...
            if direction == "front":
                ...
                concat_img[:, 1920:1920*2] = img
            elif direction == "back":
                concat_img[:, 1920*2:1920*3] = img
            elif direction == "left":
                concat_img[:, 1920*3:] = img
