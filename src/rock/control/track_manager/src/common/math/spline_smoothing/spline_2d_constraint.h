...
class Spline2dConstraint {
 public:
  ...
  bool Add2dBoundary(const std::vector<double>& t_coord,
                     ...
                     const std::vector<cyberc3::common::math::Vec2d>& ref_point,
  ...
  bool AddPointFirstDerivativeConstraint(const double t, const double dx,
                                         const double dy);
 ...
 private:
  ...
  double SignDistance(const cyberc3::common::math::Vec2d& xy_point,
