...
// utm offset for qingdao
// const double GLOBAL_ZERO_X = 246161;
// const double GLOBAL_ZERO_Y = 3988283;

// utm offset for SJTU
const double GLOBAL_ZERO_X = 349350;
const double GLOBAL_ZERO_Y = 3432459;

// utm offset for changshu
// const double GLOBAL_ZERO_X = 288850;
// const double GLOBAL_ZERO_Y = 3495959;

// utm offset for liuzhou
// const double GLOBAL_ZERO_X = 355000;
// const double GLOBAL_ZERO_Y = 2700000;
...
const double LongOriginCustom = 121.43371749;
